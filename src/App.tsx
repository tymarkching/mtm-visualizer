                      ...
                      <div className="space-y-3 pt-3.5 border-t border-zinc-850/50">
                        <div className="flex items-center justify-between">
                          ...
                          <button
                            ...
                            className={`relative w-8 h-4.5 rounded-full transition-all cursor-pointer flex-shrink-0 ${
                              visuals.overlayBeatPulse ? 'bg-pink-500' : 'bg-zinc-800'
                            }`}
                          >
                            <span className={`absolute top-[2px] left-[2px] bg-zinc-100 rounded-full h-3.5 w-3.5 transition-all ${
                        ...
                        {visuals.overlayBeatPulse && (
                          <div className="space-y-1.5 text-left border-l-2 border-pink-500/30 pl-2">
                            <div className="flex justify-between font-mono text-[9px] text-zinc-400">
                    ...
                    <div className="bg-zinc-900 border border-zinc-850 p-4 rounded-lg space-y-3.5">
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className={`relative w-8 h-4.5 rounded-full transition-all cursor-pointer flex-shrink-0 ${
                            visuals.stickerFloatRotate ? 'bg-blue-500' : 'bg-zinc-800'
                          }`}
                        >
                          <span className={`absolute top-[2px] left-[2px] bg-zinc-100 rounded-full h-3.5 w-3.5 transition-all ${
                      ...
                      {visuals.stickerFloatRotate && (
                        <div className="space-y-1.5 text-left border-l-2 border-blue-500/30 pl-2">
                          <div className="flex justify-between font-mono text-[9px] text-zinc-400">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-5">
                  ...
                  <div className="bg-zinc-900/40 border border-zinc-900 rounded-lg p-4 space-y-3.5">
                    ...
                    {activeStickers.length > 0 && (
                      <div className="space-y-3.5 pt-3.5 border-t border-zinc-850/40 pl-2.5 border-l-2 border-indigo-500/40 font-sans">
                        <h5 className="text-[9.5px] font-bold text-indigo-400 uppercase font-mono text-left">Sticker Sizing & Coordinate Positioning</h5>
                  ...
                  <div className="bg-zinc-900/40 border border-zinc-900 rounded-lg p-4 space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className={`relative w-8 h-4.5 rounded-full transition-all cursor-pointer flex-shrink-0 ${
                          visuals.customTextInvertBlend ? 'bg-cyan-500' : 'bg-zinc-800'
                        }`}
                      >
                        <span className={`absolute top-[2px] left-[2px] bg-zinc-100 rounded-full h-3.5 w-3.5 transition-all ${
                    ...
                    <div className="space-y-3.5 pt-2 border-t border-zinc-850/40">
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className={`relative w-8 h-4.5 rounded-full transition-all cursor-pointer flex-shrink-0 ${
                            visuals.customTextMarquee ? 'bg-cyan-500' : 'bg-zinc-800'
                          }`}
                        >
                          <span className={`absolute top-[2px] left-[2px] bg-zinc-100 rounded-full h-3.5 w-3.5 transition-all ${
                      ...
                      {visuals.customTextMarquee && (
                        <div className="space-y-1.5 text-left pl-2 border-l-2 border-cyan-500/30">
                          <div className="flex justify-between items-center text-[10px] font-mono">
                            <span className="text-zinc-400 font-medium">Scroll Speed</span>
                            <span className="text-cyan-500 font-semibold">{visuals.customTextScrollSpeed || 2}</span>
                          </div>
                          <input
                            type="range"
                            min="1"
                    ...
                    <div className="p-3 bg-zinc-950/40 rounded border border-zinc-850/30 space-y-3.5">
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className={`relative w-8 h-4.5 rounded-full transition-all cursor-pointer flex-shrink-0 ${
                            visuals.renderWatermark ? 'bg-indigo-600' : 'bg-zinc-800'
                          }`}
                        >
                          <span className={`absolute top-[2px] left-[2px] bg-zinc-100 rounded-full h-3.5 w-3.5 transition-all ${
                      ...
                      {visuals.renderWatermark && (
                        <div className="space-y-3.5 pl-2.5 border-l-2 border-indigo-500/30 pt-1">
                          {/* Opacity slider */}
                          <div className="space-y-1.5 text-left">
                            <div className="flex justify-between font-mono text-[9px] text-zinc-400">
                    ...
                    <div className="p-3 bg-zinc-950/40 rounded border border-zinc-850/30 space-y-3.5">
                      ...
                      {visuals.watermarkUrl ? (
                        <div className="space-y-3.5">
                          ...
                          <div className="space-y-3 pl-2.5 border-l-2 border-emerald-500/30 pt-1">
                            {/* Opacity slider */}
                            <div className="space-y-1.5 text-left">
                              <div className="flex justify-between font-mono text-[9px] text-zinc-400">
